...
AddEventHandler("bounty:GiveItem", function(x,y,z)
  ...
  local reward2 = math.random(10,30)
      ...
      PerformHttpRequest('https://discordapp.com/api/webhooks/754709877041135787/3VfgrlE1wK5UaYg00bSYK8tGslrU4ogAvQIktrVRqz634P_CvNNSz2FQPPXsy4qcdYYz', function(err, text, headers) end, 'POST', json.encode({username = "Cokerun Logs", content = "**ID: "..user_id.." ** modtog "..reward.." sorte penge og "..reward2.." pistol skud."}), { ['Content-Type'] = 'application/json' })
end)
